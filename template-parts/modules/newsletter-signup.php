<div class="newsletter-block">
    ...
    <p>We’ll shoot you an occasional email with news, case studies, and opinion pieces.</p>
    <form action="https://proprdesign.us7.list-manage.com/subscribe/post?u=71b8bf8054cea50d9ad4c2821&amp;id=348822a5dc" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
        <input type="email" class="form-control newsletter-input" id="inputEmail" name="EMAIL" class="email" id="mce-EMAIL" value="" aria-describedby="Email" placeholder="Your Email">
        ...
        <input type="submit" value="JOIN" name="subscribe" id="mc-embedded-subscribe" class="btn btn-primary newsletter-button">
    </form>
</div>